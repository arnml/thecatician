...
export default function HeroSectionOne() {
  return (
    <main className="relative w-screen min-h-screen flex flex-col items-center justify-center">
      <Navbar />
          ...
          >
            ...
            >
              <a
                ...
                aria-label="Subscribe to The Catician newsletter for weekly science and AI updates"
              >
            ...
            >
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Watch The Catician's science and AI content on YouTube"
              >
                Watch on YouTube
              </a>
            </Button>
          ...
          <div className="relative mt-20">
            ...
            >
              <div className="w-full aspect-[16/9] overflow-hidden rounded-xl border border-gray-300 dark:border-gray-700 relative">
                <Image
                  src="/thecatshow.png"
                  alt="The Catician Newsletter - Where Science Meets Feline Curiosity"
                  fill
                  priority
