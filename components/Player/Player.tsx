...
export default function Player(){
    return(
        <>
        <div className="bg-slate-100 border-slate-100 border-b rounded-t-xl p-4 pb-6 sm:p-10 sm:pb-8 lg:p-6 xl:p-10 xl:pb-8 space-y-6 sm:space-y-8 lg:space-y-6 xl:space-y-8">
        ...
        <div className="bg-slate-50 text-slate-500 rounded-b-xl flex items-center">
        ...
        <div className="flex-auto flex items-center justify-evenly">
            ...
            <button type="button" className="rounded-lg text-xs leading-6 font-semibold px-2 ring-2 ring-inset ring-slate-500 text-slate-500">
            1x
            </button>
        </div>
        </div>
